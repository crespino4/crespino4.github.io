...
class WizardApp {
     ...
     */
    getUserDetails() {
        let opts = { 'expand': ['authorization', 'groups'] };
    ...
    addInstances(groupData) {
            ...
            integrationPromises.push(
                this.integrationsApi.postIntegrations(integrationBody)
                    .then((data) => {
                        ...
                        console.log('integrationConfig', JSON.stringify(integrationConfig));
        ...
        console.log('integrationPromises', integrationPromises)
    ...
    getExistingAuthClients1() {
        return this.oAuthApi.getOauthClients()
            .then((data) => {
                ...
                return (data.entities
                    .filter(entity => {
                        if (entity.name && entity.name.startsWith(this.prefix)) {
                            return entity;
                        } else
                            return "";
                    }));
    ...
    getExistingOAuthClient1(clientId) {
        return this.oAuthApi.getOauthClient(clientId)
            .then((data) => {
                console.log('==================================');
                console.log(data);
                return data;
    ...
    _pureCloudAuthenticate() {
        // alert('pcEnvironment=' + this.pcApp.pcEnvironment)
